...
export default function About() {
    ...
    return(
        ...
        transition={{delay:0.175}}>
            ...
            <p className=" text-white font-alias text-3xl font-bold mx-16">
            ...
            projects, including a bot that can play games for me, a full-stack web application centered around Chess
            and a website that simplifies technical documents, I&apos;m adept 
